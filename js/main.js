...
// برمجة إظهار نموذج تسجيل الدخول
...
// برمحة إظهار نموذج إنشاء الحساب
document.querySelector('#signUp_btn').onclick = () =>{
    document.querySelector('.signUp_form_container').classList.toggle('active');
}

document.querySelector('#close_signUp_form').onclick = () =>{
    document.querySelector('.signUp_form_container').classList.remove('active');
}
...
var swiper = new Swiper(".tires_slider", {
    slidesPerView: 1,
    spaceBetween: 20,
    loop:true,
    grabCursor: true,
